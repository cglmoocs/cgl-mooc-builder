...
/*
  ...
  Antiscroll.prototype.refresh = function() {
    var needHScroll = this.inner.get(0).scrollWidth > this.el.width()
      , needVScroll = this.inner.get(0).scrollHeight > (this.el.height() + 60);

	if(!this.horizontal && needHScroll && this.x && false) {//Horizontal scrollbar is not needed
  ...
  function Scrollbar (pane) {
    ...
    if (initialDisplay !== false) {
      this.show();
      this.hiding = setTimeout($.proxy(this, 'hide'), parseInt(initialDisplay, 10) || 1200);
    }
  };
